...
// 	var div_radio = document.getElementById('checkbox');
// 	var label_one = document.createElement('label');
// 			label_one.className="checkbox-inline";
// 	var label_one_text = document.createTextNode('Job Title');
